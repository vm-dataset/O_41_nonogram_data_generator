...
"""
╔══════════════════════════════════════════════════════════════════════════════╗
║                    NONOGRAM TASK GENERATION SCRIPT                            ║
║                                                                               ║
║  Run this to generate nonogram (picross) task datasets.                       ║
║  Generates puzzles with various patterns and difficulty levels.               ║
╚══════════════════════════════════════════════════════════════════════════════╝

Usage:
    python examples/generate.py --num-samples 100
    python examples/generate.py --num-samples 100 --output data/my_nonograms --seed 42
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate nonogram task dataset",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
    python examples/generate.py --num-samples 10
    python examples/generate.py --num-samples 100 --output data/nonograms --seed 42
        """
    )
    parser.add_argument(
        "--num-samples",
    ...
    print(f"🧩 Generating {args.num_samples} nonogram tasks...")
    
    # ──────────────────────────────────────────────────────────────────────────
    #  Configure nonogram task generation
